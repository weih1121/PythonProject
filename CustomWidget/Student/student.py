...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollArea_student.setGeometry(QtCore.QRect(89, 60, 831, 511))
        self.scrollArea_student.setWidgetResizable(True)
        self.scrollArea_student.setObjectName("scrollArea_student")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 829, 509))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.gridLayout = QtWidgets.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout.setObjectName("gridLayout")
        self.widget_student = CustomWidget("StudentTest", self.scrollAreaWidgetContents)
        self.widget_student.setObjectName("widget_student")
        self.gridLayout.addWidget(self.widget_student, 0, 0, 1, 1)
