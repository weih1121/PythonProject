...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_col = QtWidgets.QSpinBox(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(510, 20, 136, 47))
        self.widget1.setObjectName("widget1")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget1)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_groupView = QtWidgets.QLabel(self.widget1)
        self.label_groupView.setObjectName("label_groupView")
        self.verticalLayout.addWidget(self.label_groupView)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label = QtWidgets.QLabel(self.widget1)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.comboBox_group = QtWidgets.QComboBox(self.widget1)
